    ...
    public partial class FrmExportSedeCentralHistorias : Form
    {
                            ...
                            using (SqlConnection connection = new SqlConnection(Conexion.conexionSQL))
                            {
                                ...
                                if (TabTratamientoCen.HasRows == false)
                                {
                                    ...
                                    $"{Conexion.ValidarFechaNula(TabTratamiento["FechaModify"].ToString())}" +
                                     ...
                                     $"{Conexion.ValidarFechaNula(TabTratamiento["FecNotFlu"].ToString())}" +
                                     "'" + TabTratamiento["TipoFluorisis"].ToString() + "'" +
                                    ")";
                                ...
                                else
                                {
                                   ...
                                   "NumTrataM1 ='" + TabTratamiento["NumTrataM1"].ToString() + "'," +
                                    ...
                                    $"FecNotFlu = {Conexion.ValidarFechaNula(TabTratamiento["FecNotFlu"].ToString())}" +
                                    "TipoFluorisis ='" + TabTratamiento["TipoFluorisis"].ToString() + "'" +
        ...
        private void BtnBuscarPacientes_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ExportarHistorias.IsBusy != true) //Si el proceso esta corriendo no puede voler a iniciarse 
                {
                    ...
                    Utils.Informa = "¿Usted desea iniciar el proceso de exportación de" + "\r";
                    ...
                    if (res == DialogResult.Yes)
                    {
                        ...
                        if (totalAten != 0)
                        {
                            ...
                            ExportarHistorias.RunWorkerAsync();
        ...
        private void ExportarHistorias_DoWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    foreach (DataRow TabHistoCli in DtTabHistoCli.Rows)
                    {
                        ...
                        if (ExportarHistorias.CancellationPending == true)
                        {
                            e.Cancel = true;
                            Utils.Titulo01 = "Control de ejecución";
                        ...
                        if(proce == 1)
                        {
                            ...
                            "'" + TabHistoCli["CodEspeciSalida"].ToString().Replace("'", "''") + "'," +
                        ...
                        else if(proce == 2)
                        {
                            ...
                            "CodEspeciSalida = '" + TabHistoCli["CodEspeciSalida"].ToString().Replace("'", "''") + "'," +
                            ...
                            globalCanhisFormExis += 1;

                        }


                        ExportarHistorias.ReportProgress(contador);
            ...
            catch (Exception ex)
            {
                ...
                Utils.Informa += "Error: " + ex.Message + " - " + ex.StackTrace;
                MessageBox.Show(Utils.Informa, Utils.Titulo01, MessageBoxButtons.OK, MessageBoxIcon.Error);
                ExportarHistorias.CancelAsync();
            }
        }

        private void ExportarHistorias_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            try
            {
                if (ExportarHistorias.CancellationPending == false)
                {
        ...
        private void ExportarHistorias_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                Utils.Titulo01 = "Control para exportar datos";
                ...
                TxtCanHistFor.Text = globalCanHistFor.ToString();
                TxtCanhisFormExis.Text = globalCanhisFormExis.ToString();
        ...
        private void BtnDetener_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (res2 == DialogResult.Yes)
                {
                    ...
                    ExportarHistorias.WorkerSupportsCancellation = true;
                    ExportarHistorias.CancelAsync();
